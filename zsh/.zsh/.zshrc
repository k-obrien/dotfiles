...
autoload -Uz adbsetput  # Add entry to Settings database on Android device
autoload -Uz aanimscl   # Set animation scale on Android device
autoload -Uz afontscl   # Set font scale on Android device
autoload -Uz abounds    # Toggle layout bounds visibility on Android device
autoload -Uz adbin      # Dispatch input to Android device
autoload -Uz adbtype    # Dispatch text input to Android device
autoload -Uz adbkey     # Dispatch key input to Android device
autoload -Uz adbtap     # Dispatch touch input to Android device
autoload -Uz atalkback  # Toggle TalkBack service on Android device
autoload -Uz atouches   # Toggle touch visibility on Android device
